...
function Set-SumoLogicApiCollectorSource
{
    ...
    try
    {
        ...
        if ($PSBoundParameters.Async.IsPresent)
        {
            ...
            Invoke-SumoLogicInvokeCollectorAsync -Command $command -CollectorIds $CollectorIds -credential $Credential -Body $json
        }
        else
        {
